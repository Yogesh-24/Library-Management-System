...
public class BookServlet extends HttpServlet {
    ...
    public void init() throws ServletException {
        bookDAO = new BookDAOImpl(); // Initialize the BookDAO implementation
    }
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        switch (action) {
            ...
            case "remove":
                ...
                break;
            case "viewAll": // Handle the viewAll action
                viewAllBooks(request, response);
                break;
            default:
                response.sendRedirect("index.jsp"); // Handle unexpected actions
                break;
        }
    }
    ...
    private void removeBook(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        try {
            ...
            request.getRequestDispatcher("error.jsp").forward(request, response); // Redirect to error page if invalid ID
        }
    }
